...
import { getUTCTimefromUTCTime } from '../../utils';
                ...
                <div className='bet-history-detail-modal user-history fixed w-full h-full bg-black z-20 text-white flex flex-col overflow-auto pb-12' style={{ width: "100%", fontFamily: "Roboto" }}>
                    <div className="user-data m-auto">
                        <div className="data-header">
                            <img src={`${VITE_API_ASSETS_IMAGE_URL}back.png`} alt="back" className='float-left cursor-pointer align-middle mx-4' onClick={() => setShowDetail(false)} />
                            Game {data?.id}
                        </div>
                        <div className="data-body relative">
                            <div className={`${loading ? "flex" : "hidden"} justify-center items-center absolute top-0 w-full h-full z-10 bg-black/50`}>
                                <img src={`${VITE_API_ASSETS_IMAGE_URL}loading.gif`} alt="loading..." width={120} height={120} />
                            </div>
            ...
            <div className="user-history overflow-y-auto" style={{ fontFamily: "Roboto" }}>
                ...
                <div className="user-data">
                    <div className="data-header text-center">
                        ...
                        <img src={`${VITE_API_ASSETS_IMAGE_URL}back.png`} alt="back" className='float-left cursor-pointer align-middle ml-4' onClick={() => setChildContent(<></>)} />  My games
                    </div>
                    <div className="data-body relative">
                        <div className={`${loading ? "flex" : "hidden"} justify-center items-center absolute top-0 w-full h-full z-10 bg-black/50`}>
                            <img src={`${VITE_API_ASSETS_IMAGE_URL}loading.gif`} alt="loading..." width={120} height={120} />
